<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="bakeryadmin.aspx.cs" Inherits="Default6" %>
...
&nbsp;&nbsp;
                    &nbsp;&nbsp;
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Bakerymanagement.aspx">Go to Admin Page</asp:HyperLink>
                    </td>
            </tr>
        </table>
