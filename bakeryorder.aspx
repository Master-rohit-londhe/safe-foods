<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="bakeryorder.aspx.cs" Inherits="bakeryorder" %>
        ...
        <table class="auto-style2" align="center" bgcolor="#FF9933" style="border: 10px groove #FFFFFF; background-image: url('images/bg1.jpg');">
            ...
            <tr>
                ...
                <td style="color: #FFFFFF" class="auto-style14">
                    <asp:TextBox ID="TextBox8" runat="server" CssClass="buttoncss" Visible="true"></asp:TextBox>
                    <br />
                    <br />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="color: #FFFFFF" class="auto-style7">
                    <br />
                    <asp:TextBox ID="TextBox7" runat="server" CssClass="buttoncss" ReadOnly="True" OnTextChanged="TextBox7_TextChanged"></asp:TextBox>
                    <br />
                    <br />
                </td>
            </tr>
