<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="cafe.aspx.cs" Inherits="cafe" %>
    ...
    <table class="style1">
        <tr>
            <td style="background-color: #000000;">
                <asp:DataList ID="DataList1" runat="server" CellPadding="40" CellSpacing="1" DataKeyField="product_id" DataSourceID="SqlDataSource1" RepeatColumns="1" Width="1598px" BackColor="Black" Height="2091px" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [restproduct]where catagory='caffe'"></asp:SqlDataSource>
            </td>
        </tr>
    </table>
</asp:Content>
