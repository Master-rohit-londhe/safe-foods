<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="cakegallery.aspx.cs" Inherits="cakegallery" %>
...
<br />
                        ...
                        <asp:Button ID="Button4" runat="server" Visible="False" Text='<%# Eval("product_id") %>' OnClick="Button4_Click" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [bakeryproduct]where catagory='Cake'"></asp:SqlDataSource>
                <br />
                <br />
            </td>
        </tr>
