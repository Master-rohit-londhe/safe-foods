<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="coldrinks_gallery.aspx.cs" Inherits="Default3" %>
...
<br />
                        ...
                        o<asp:Button ID="Button3" runat="server" BackColor="#FF6600" CssClass="lablecss" Text="Add To Card" OnClick="Button3_Click" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [bakeryproduct]where catagory='colddrinks'"></asp:SqlDataSource>
            </td>
        </tr>
    </table>
</asp:Content>
