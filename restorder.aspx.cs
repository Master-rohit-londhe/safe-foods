...
public partial class restorder : System.Web.UI.Page
{
    string cs;
    static int av;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            cn.Open();
            SqlDataAdapter adpr = new SqlDataAdapter("Select * from restproduct where product_id ='" + Session["demo"].ToString() + "'", cn);
    ...
    void UpdateQty()
    {
        ...
        SqlConnection cn = new SqlConnection(cs);
        cn.Open();
        SqlCommand cmd = new SqlCommand("Select * from  restproduct where product_id='" + TextBox8.Text + "'", cn);
        ...
        SqlCommand cmd1 = new SqlCommand("update  restproduct set up_stock=@aqt where product_id='" + TextBox8.Text + "'", cn1);
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection cn = new SqlConnection(cs);
        cn.Open();
        SqlCommand cmd = new SqlCommand("Insert into placeorderrest(user_name,contact,product_name,pro_img,price,qty,amt,city,uad,o_date)values(@un,@co,@pn,@pi,@pr,@qt,@am,@ci,@ad,@da)", cn);
        ...
        Response.Redirect("ordersuccessfull1.aspx");
