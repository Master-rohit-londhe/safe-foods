<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="restproductreport.aspx.cs" Inherits="restproductreport" %>
        ...
        <tr>
            <td style="text-align: center">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT distinct [catagory] FROM [restproduct]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td>
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                    ...
                    CssClass="report">
                    <LocalReport ReportPath="restproductreport.rdlc">
                        <DataSources>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                    ...
                    TypeName="restaurantcatagoryTableAdapters.restproductTableAdapter">
