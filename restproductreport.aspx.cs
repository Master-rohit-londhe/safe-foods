...
public partial class restproductreport : System.Web.UI.Page
{
    string cs;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select * from restproduct where catagory=@cate  ", cn);
        ...
        rpt.LocalReport.ReportPath = "restproductreport.rdlc";
