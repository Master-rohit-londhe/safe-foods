<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sweetgallery.aspx.cs" Inherits="Default2" %>
        ...
        <tr>
            <td style="background-image: url('images/bg1.jpg')">
                <asp:DataList ID="DataList1" runat="server" CellPadding="20" CellSpacing="40" DataKeyField="product_id" DataSourceID="SqlDataSource1" RepeatColumns="4" RepeatDirection="Horizontal" Width="1532px" BackColor="Black">
                    <ItemTemplate>
                        p<asp:Label ID="Label6" runat="server" CssClass="lablecss" ForeColor="White" Text='<%# Eval("product_id") %>'></asp:Label>
                        <br />
                        <br />
...
<br />
                        ...
                        <br />
                        s
                        <asp:Button ID="Button2" runat="server" BackColor="#FF6600" CssClass="lablecss" Text="Order" OnClick="Button2_Click" />
                        ecif<asp:Button ID="Button3" runat="server" BackColor="#FF6600" CssClass="lablecss" Text="Add To Card" OnClick="Button3_Click" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [bakeryproduct]where catagory='sweet'"></asp:SqlDataSource>
            </td>
        </tr>
    </table>
</asp:Content>
